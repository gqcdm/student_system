...
<div class="container-fluid">
    <div class="row" style="margin-top: 10%;">
        <div class="col-sm-12">
            <ul class="list-group">
                <li class="list-group-item"><a href="${pageContext.request.contextPath}/student/findByPage" target="main">学生管理</a></li>
                <c:if test="${sessionScope.user.role=='admin'}">
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/group/findAllGroup" target="main">小组管理</a></li>
                    ...
                    <li class="list-group-item"><a href="${pageContext.request.contextPath}/city/findByPage" target="main">城市管理</a></li>
                </c:if>
