...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-12" style="margin-bottom: 10px; ">
			...
			<input type="button" value="添加小组" class="btn btn-sm btn-info" onclick="location.href='${pageContext.request.contextPath}/group/findAll'"/>
		</div>
		<div class="col-sm-12">
			<table class="table table-striped table-bordered table-hover">
				...
				<c:forEach items="${requestScope.allGroup}" var="group">
					<tr>
						...
						<td>
							<c:forEach items="${group.tags}" var="tagName">
								<span class="label label-success">${tagName}</span>、
							</c:forEach>
						</td>
						<td>
							<span class="label label-primary">${group.num}</span>
						</td>
