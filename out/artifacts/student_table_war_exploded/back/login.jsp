            ...
            <form action="${pageContext.request.contextPath}/load/login" method="post">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <img src="${pageContext.request.contextPath}/load/code" id="img" style="float: right;height: 40px;width: 30%;cursor: pointer" onclick="this.src='${pageContext.request.contextPath}/load/code?'+Math.random()"/>
                    </div>
                </div>
